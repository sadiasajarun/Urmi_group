...
3. **Investigation Steps**:
    ...
    - After taking screenshots, check `.claude-project/screenshots/` for the saved images
...
2. Screenshots are saved to `.claude-project/screenshots/`
...
- `.claude/react/docs/typescript-standards.md` - TypeScript error patterns and best practices
- `.claude/react/docs/best-practices.md` - React coding standards

### React & Components
- `.claude/react/docs/component-patterns.md` - React component issues and structure
- `.claude/react/docs/loading-and-error-states.md` - Async/loading issues

### Data & API
- `.claude/react/docs/data-fetching.md` - API/fetch errors
- `.claude/react/docs/tanstack-query.md` - TanStack Query errors and patterns

### Styling
- `.claude/react/docs/styling-guide.md` - CSS/Tailwind issues
